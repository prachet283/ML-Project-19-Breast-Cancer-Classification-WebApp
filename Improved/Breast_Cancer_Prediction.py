...
with open("Improved/columns.pkl", 'rb') as f:
    all_features = pickle.load(f)
with open("Improved/scaler.pkl", 'rb') as f:
    scalers = pickle.load(f)
with open("Improved/best_features_lr.json", 'r') as file:
    best_features_lr = json.load(file)
with open("Improved/best_features_xgb.json", 'r') as file:
    best_features_xgb = json.load(file)
with open("Improved/best_features_knn.json", 'r') as file:
    best_features_knn = json.load(file)
with open("Improved/parkinsons_disease_trained_lr_model.sav", 'rb') as f:
    loaded_model_lr = pickle.load(f)
with open("Improved/parkinsons_disease_trained_xgb_model.sav", 'rb') as f:
    loaded_model_xgb = pickle.load(f)
with open("Improved/parkinsons_disease_trained_knn_model.sav", 'rb') as f:
